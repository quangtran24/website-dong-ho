...
if (isset($_COOKIE['usidtf'])) {
  $s = "SELECT * FROM NgườiDùng WHERE MãNgườiDùng = '" . $_COOKIE['usidtf'] . "'";
...
if ($result) {
  ...
  echo "Lỗi trong quá trình thực thi câu truy vấn SQL: " . mysqli_error($conn);
}
...
<html lang="vi">
<head>
  <title>L8Watch - Không Ngừng Chuyển Động!</title>
  <meta charset="utf-8">
...
<body>
  <header id='header'>
    <a href="index.php"><img src="images/logo.png"><h2 class="logo">L8Watch</h2></a>
    <ul class="header-menu">
      ...
      <?php } else { ?>
      <li><a onclick="$('#user-setting').toggle()" id="s-s" data-stt='alreadysignin'>Chào <?php echo $_SESSION['user']['Tên'] ?></a><div class='mn-ef'></div></li>
      <div id='user-setting'>
        <ul>
  ...
  <nav class="navbar navbar-default" role="navigation" id="nav">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand logo" href="index.php">L8Watch</a>
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
          <li class="dropdown menu-name">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a onclick="ajax_danhmucsp('rolex')">Rolex (Thụy Sỹ)</a></li>
              <li><a onclick="ajax_danhmucsp('cartier')">Cartier (Pháp)</a></li>
              <li><a onclick="ajax_danhmucsp('omega')">Omega (Thụy Sỹ)</a></li>
              <li><a onclick="ajax_danhmucsp('patek')">Patek Philippe (Thụy Sỹ)</a></li>
              <li><a onclick="ajax_danhmucsp('piaget')">Piaget (Thụy Sỹ)</a></li>
        ...
        <div class="navbar-form navbar-right searchbox-desktop">
          <div class="form-group">
            <input type="text" class="form-control" placeholder="Bạn tìm gì? thì tìm đi" id='srch-val'>
          </div>
